 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Del  | Ctrl | Alt  | GUI  |Lower |    Space    |Raise |   /  | Left | Down |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_mit(
    ...
    KC_DEL,  KC_LCTL, KC_LALT, KC_LGUI, LOWER,       KC_SPC,       RAISE,   KC_SLSH, KC_LEFT, KC_DOWN, KC_RGHT
),
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |MUSmod|Aud on|Audoff|AGnorm|AGswap|Qwerty|Colemk|Dvorak|Wrkman|      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
